		...
		<script>
			...
			$(".editbutton").click(function() {
		        ...
		        var request = $.ajax({
		        	url: "<?php echo base_url();?>index.php/subjects/list_edit_subject",
		        	type: 'POST',
		        	data: form_data
		        });
		        ...
		        request.done(function (response, textStatus, jqXHR){
					...
					temp = response.split("*");
			       	$('#editCode').val(temp[0]);
			       	$('#editSubject').val(temp[1]);
			       	$('#editUnits').val(temp[2]);
			    });
			...
			$("#triggerdelete").click(function() {
		        window.location.href = "<?php echo base_url();?>index.php/subjects/delete_subject/" + deleteid;				    	
			});
			...
			$("#triggerdelall").click(function() {
		        window.location.href = "<?php echo base_url();?>index.php/subjects/delete_all_subject";				    	
			});
			
			<?php if(!is_null($add_subject_error_action)) echo $add_subject_error_action;?>
