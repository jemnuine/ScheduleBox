<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
					...
					<table class="table table-striped">
						...
						<?php if(isset($records)) : foreach($records as $row) : ?>
							<tr>
								...
								<td class="">
									<a id="<?php echo $row->subject_id;?>" style="cursor:pointer;" class="deletebutton pull-right"><i class="icon-trash"></i></a>
									<a id="<?php echo $row->subject_id;?>" style="cursor:pointer;" class="editbutton pull-right"><i class="icon-pencil"></i></a>	
								</td>
							</tr>
							<?php endforeach;?>
						...
						<div class="well">
					        <ul class="nav nav-list">
					          ...
					          <li><a href="<?php echo base_url();?>index.php/sections">Sections</a></li>
					     	  <li class="active"><a href="<?php echo base_url();?>index.php/subjects">Subjects</a></li>
		...
		<!-- Add Subject Modal -->
		<div id="modalAddSubject" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<!-- Modal Header -->
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></button>
				<h3 id="myModalLabel">Add New Subject </h3>
			</div>
			<!-- Modal Header -->
			<?php if(!is_null($add_subject_error_msg)) echo $add_subject_error_msg;?>  
			<br/>
			<form action='<?php echo base_url();?>index.php/subjects/add_subject' method='post' name='register'>
				<!-- Modal Content -->
				<table cellpadding="0" align=center>
					...
					<tr>
						<td>Subject Name: </td>
						<td>&nbsp;</td>
						<td><input type='text' name='addSubject' id='addSubject' size='25' /></td>
					</tr>
					<tr>
						<td>Number of Units: </td>
						<td>&nbsp;</td>
						<td><input type='text' name='addUnits' id='addUnits' size='25' /></td>
					</tr>
