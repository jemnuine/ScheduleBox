			...
			<form action='<?php echo base_url();?>index.php/' method='post' name='register'>
				...
				<table cellpadding="0" align=center>
					<tr>
						<td>Subject Code: </td>
						<td>&nbsp;</td>
						<td><input type='text' name='add_subject_code' id='add_subject_code' size='25' /></td>
					</tr>
					<tr>
						<td>Subject Name: </td>
						<td>&nbsp;</td>
						<td><input type='text' name='add_subject_name' id='add_subject_name' size='25' /></td>
					</tr>
					<tr>
						<td>Number of Units: </td>
						<td>&nbsp;</td>
						<td><input type='text' name='add_number_units' id='add_number_units' size='25' /></td>
					</tr>
